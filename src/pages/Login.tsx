        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card p-8 surveillance-glow animate-fade-in-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="button"
                className="w-full bg-white text-gray-900 border border-gray-300 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200 flex items-center justify-center space-x-2"
              >
